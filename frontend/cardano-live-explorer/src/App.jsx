...
function App() {
  ...
  useEffect(() => {
    ...
    // Check if already connected (socket connects before component mounts)
    if (socket.connected) {
      setIsConnected(true);
    }
    ...
    <Layout>
      ...
      <main className="w-full space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="glass-panel rounded-2xl p-8 relative overflow-hidden group border-2 border-blue-500/10 hover:border-blue-500/20 transition-all">
              ...
              <p className="text-base text-gray-400 mt-4 flex items-center gap-2.5">
                <span
                  className={`w-2.5 h-2.5 rounded-full ${
                    isConnected ? "bg-green-500" : "bg-rose-400"
                  }`}
                ></span>
        ...
        {isConnected && blocks.length === 0 && (
          <div className="glass-panel rounded-2xl px-10 py-8 flex items-center gap-8 animate-fade-in relative overflow-hidden border-2 border-blue-500/10">
            <div className="absolute inset-0 bg-blue-500/5"></div>
            <div className="relative flex h-16 w-16 flex-none items-center justify-center rounded-2xl bg-blue-600 ring-2 ring-blue-500">
              <svg
